...
// The API key is stored securely in chrome.storage.local
// To set it up, use the extension popup or run this in the console:
...
Respond with ONLY a JSON object in this exact format:
{
  ...
  "reason": "brief explanation"
    ...
    if (!apiKey) {
      return { 
        isProductive: false, 
        reason: 'No Gemini API key found. Please set it using: chrome.storage.local.set({ geminiApiKey: "YOUR_KEY" })' 
      };
    }
