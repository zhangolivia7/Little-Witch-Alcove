...
function showHexActivation() {
  ...
  message.textContent = 'Hex of Concentration Cast!';
  ...
  message.style.cssText = `
    ...
    font-size: 28px;
    color: #CAAFE5;
    text-shadow: 0 0 15px #CAAFE5, 0 0 30px #CAAFE5, 0 0 45px #CAAFE5;
    z-index: 10001;
    pointer-events: none;
    white-space: nowrap;
...
function createSuccessMessage(container) {
  ...
  message.style.cssText = `
    ...
    font-size: 36px;
    color: #CAAFE5;
    text-shadow: 0 0 20px #CAAFE5, 0 0 40px #CAAFE5, 0 0 60px #CAAFE5;
    z-index: 10001;
    pointer-events: none;
    white-space: nowrap;
